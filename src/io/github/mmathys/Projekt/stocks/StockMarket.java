...
public class StockMarket {
	...
	private void initMarket() {
		/**
		 * Stocks: ABC Alphabet LPI Laredo Petroleum Inc NBL Noble Energy Inc
		 * OPK Opko Health Inc XEC Cimarex Energy Co CRM Salesforce.com Inc XPO
		 * XPO Logistics Inc SNP Snapchat Inc BXP Boston Properties Inc NFX
		 * Newfield Exploration Co GRD Greedy Company Co RHT Red Hat Inc MCX
		 * Gazprom PAO AMX America Movil SAB de CV VZN Verizon Communications
		 * AKS AK Steel Holding Corp.
		 */

		Stock[] stocksArray = { new Stock("ABC", "Alphabet", 3_000_000_000f, .4f),
				...
				new Stock("RHT", "Red Hat Inc", 1_203_454f, .4f), new Stock("MCX", "Gazprom PAO", 50_023_234_232f, .1f),
