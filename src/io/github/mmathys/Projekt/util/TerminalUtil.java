...
public class TerminalUtil {
	...
	public static void printStockInfo(Stock target) {
		System.out.println(TerminalUtil.altInfo(target.getName() + " (" + target.getShortName() + "), Kurs: "
	...
	public static void printAccountStockInfo(Investment i) {
		System.out
				.println(TerminalUtil.altInfo(i.getStock().getName() + " (" + i.getStock().getShortName() + "), Kurs: "
						+ TerminalUtil.formatCyclePercent(i.getStock().getCyclePercent(),
								i.getStock().getCyclePercentString())
