...
public class Main {
	...
	public static void main(String[] args) {
		...
		introDialogue.addLine("Dein Chef war so nett und spendierte dir ein Startkapital von "
				+ TerminalUtil.moneyFormat(player.getCapital()) + ".");
		introDialogue.addLine(
				"Dein Chef verlangt von dir, dass du in die besten Aktien investierst und einen Gewinn für das Geschäft erzielst.");
